...
async fn test_parquet_scanned_bytes() {
    ...
    +-------------------------------+---------------------+---------------------+
    | bound-object                  | 167 245 (1.7%)      | 167 245 (1.7%)      |
    +-------------------------------+---------------------+---------------------+
    | bound-predicate               | 1 000 472 (10.0%)   | 1 000 472 (10.0%)   |
    +-------------------------------+---------------------+---------------------+
    | bound-subject                 | 2 241 394 (22.3%)   | 2 241 394 (22.3%)   |
    +-------------------------------+---------------------+---------------------+
    | load-review                   | 5 135 590 (51.2%)   | 5 135 590 (51.2%)   |
    +-------------------------------+---------------------+---------------------+
    | load-review-with-lang-filter  | 5 135 590 (51.2%)   | 5 135 590 (51.2%)   |
    +-------------------------------+---------------------+---------------------+
    | explore-q1                    | 1 716 522 (17.1%)   | 1 716 522 (17.1%)   |
    +-------------------------------+---------------------+---------------------+
    | explore-q10                   | 2 944 965 (29.3%)   | 2 944 965 (29.3%)   |
    +-------------------------------+---------------------+---------------------+
    | explore-q11                   | 1 383 088 (13.8%)   | 1 383 088 (13.8%)   |
    +-------------------------------+---------------------+---------------------+
    | explore-q12                   | 2 591 157 (25.8%)   | 2 591 157 (25.8%)   |
    +-------------------------------+---------------------+---------------------+
    | explore-q2-empty-optional     | 4 895 143 (48.8%)   | 4 895 143 (48.8%)   |
    +-------------------------------+---------------------+---------------------+
    | explore-q2-non-empty-optional | 4 942 701 (49.2%)   | 4 942 701 (49.2%)   |
    +-------------------------------+---------------------+---------------------+
    | explore-q3                    | 2 710 095 (27.0%)   | 2 710 095 (27.0%)   |
    +-------------------------------+---------------------+---------------------+
    | explore-q4                    | 4 064 798 (40.5%)   | 4 064 798 (40.5%)   |
    +-------------------------------+---------------------+---------------------+
    | explore-q5                    | 1 610 238 (16.0%)   | 1 610 238 (16.0%)   |
    +-------------------------------+---------------------+---------------------+
    | explore-q7                    | 8 775 337 (87.4%)   | 8 775 337 (87.4%)   |
    +-------------------------------+---------------------+---------------------+
    | explore-q8                    | 10 964 381 (109.2%) | 10 964 381 (109.2%) |
    +-------------------------------+---------------------+---------------------+
    | explore-q9                    | 1 516 588 (15.1%)   | 1 516 588 (15.1%)   |
    +-------------------------------+---------------------+---------------------+
    | bi-q1                         | 4 837 782 (48.2%)   | 4 837 782 (48.2%)   |
    +-------------------------------+---------------------+---------------------+
    | bi-q2                         | 996 475 (9.9%)      | 996 475 (9.9%)      |
    +-------------------------------+---------------------+---------------------+
    | bi-q3                         | 520 706 (5.2%)      | 520 706 (5.2%)      |
    +-------------------------------+---------------------+---------------------+
    | bi-q4                         | 5 576 737 (55.5%)   | 5 576 737 (55.5%)   |
    +-------------------------------+---------------------+---------------------+
    | bi-q5                         | 5 697 412 (56.7%)   | 5 697 412 (56.7%)   |
    +-------------------------------+---------------------+---------------------+
    | bi-q6                         | 2 996 072 (29.8%)   | 2 996 072 (29.8%)   |
    +-------------------------------+---------------------+---------------------+
    | bi-q7                         | 3 242 465 (32.3%)   | 3 242 465 (32.3%)   |
    +-------------------------------+---------------------+---------------------+
    | bi-q8                         | 5 944 689 (59.2%)   | 5 944 689 (59.2%)   |
    +-------------------------------+---------------------+---------------------+
    ");
}
