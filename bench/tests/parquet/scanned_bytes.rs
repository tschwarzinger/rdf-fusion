...
async fn test_parquet_scanned_bytes() {
    ...
    +-------------------------------+---------------------+---------------------+---------------------+
    | bound-object                  | 161 637 (1.6%)      | 161 637 (1.6%)      | 2 365 520 (23.5%)   |
    +-------------------------------+---------------------+---------------------+---------------------+
    | bound-predicate               | 812 875 (8.1%)      | 812 875 (8.1%)      | 818 913 (8.1%)      |
    +-------------------------------+---------------------+---------------------+---------------------+
    | bound-subject                 | 2 120 871 (21.2%)   | 2 120 871 (21.2%)   | 2 951 638 (29.3%)   |
    +-------------------------------+---------------------+---------------------+---------------------+
    | load-review                   | 5 006 342 (50.0%)   | 5 006 342 (50.0%)   | 6 737 818 (66.8%)   |
    +-------------------------------+---------------------+---------------------+---------------------+
    | load-review-with-lang-filter  | 5 006 342 (50.0%)   | 5 006 342 (50.0%)   | 6 737 818 (66.8%)   |
    +-------------------------------+---------------------+---------------------+---------------------+
    | explore-q1                    | 1 421 103 (14.2%)   | 1 421 103 (14.2%)   | 2 662 538 (26.4%)   |
    +-------------------------------+---------------------+---------------------+---------------------+
    | explore-q10                   | 2 478 451 (24.7%)   | 2 478 451 (24.7%)   | 2 766 756 (27.4%)   |
    +-------------------------------+---------------------+---------------------+---------------------+
    | explore-q11                   | 1 270 050 (12.7%)   | 1 270 050 (12.7%)   | 4 056 974 (40.2%)   |
    +-------------------------------+---------------------+---------------------+---------------------+
    | explore-q12                   | 2 204 579 (22.0%)   | 2 204 579 (22.0%)   | 8 989 504 (89.1%)   |
    +-------------------------------+---------------------+---------------------+---------------------+
    | explore-q2-empty-optional     | 4 139 067 (41.3%)   | 4 139 067 (41.3%)   | 19 239 013 (190.8%) |
    +-------------------------------+---------------------+---------------------+---------------------+
    | explore-q2-non-empty-optional | 4 590 217 (45.8%)   | 4 590 217 (45.8%)   | 19 690 757 (195.3%) |
    +-------------------------------+---------------------+---------------------+---------------------+
    | explore-q3                    | 1 408 680 (14.1%)   | 1 408 680 (14.1%)   | 2 729 896 (27.1%)   |
    +-------------------------------+---------------------+---------------------+---------------------+
    | explore-q4                    | 3 473 960 (34.7%)   | 3 473 960 (34.7%)   | 5 960 609 (59.1%)   |
    +-------------------------------+---------------------+---------------------+---------------------+
    | explore-q5                    | 1 422 641 (14.2%)   | 1 422 641 (14.2%)   | 4 881 979 (48.4%)   |
    +-------------------------------+---------------------+---------------------+---------------------+
    | explore-q7                    | 6 762 473 (67.5%)   | 6 762 473 (67.5%)   | 5 781 300 (57.3%)   |
    +-------------------------------+---------------------+---------------------+---------------------+
    | explore-q8                    | 10 794 394 (107.7%) | 10 794 394 (107.7%) | 9 500 613 (94.2%)   |
    +-------------------------------+---------------------+---------------------+---------------------+
    | explore-q9                    | 1 250 617 (12.5%)   | 1 250 617 (12.5%)   | 3 375 608 (33.5%)   |
    +-------------------------------+---------------------+---------------------+---------------------+
    | bi-q1                         | 4 075 815 (40.7%)   | 4 075 815 (40.7%)   | 5 125 610 (50.8%)   |
    +-------------------------------+---------------------+---------------------+---------------------+
    | bi-q2                         | 808 878 (8.1%)      | 808 878 (8.1%)      | 2 873 008 (28.5%)   |
    +-------------------------------+---------------------+---------------------+---------------------+
    | bi-q3                         | 516 794 (5.2%)      | 516 794 (5.2%)      | 613 408 (6.1%)      |
    +-------------------------------+---------------------+---------------------+---------------------+
    | bi-q4                         | 4 698 443 (46.9%)   | 4 698 443 (46.9%)   | 6 163 854 (61.1%)   |
    +-------------------------------+---------------------+---------------------+---------------------+
    | bi-q5                         | 4 831 505 (48.2%)   | 4 831 505 (48.2%)   | 7 771 954 (77.1%)   |
    +-------------------------------+---------------------+---------------------+---------------------+
    | bi-q6                         | 2 906 431 (29.0%)   | 2 906 431 (29.0%)   | 3 206 340 (31.8%)   |
    +-------------------------------+---------------------+---------------------+---------------------+
    | bi-q7                         | 2 757 060 (27.5%)   | 2 757 060 (27.5%)   | 2 812 177 (27.9%)   |
    +-------------------------------+---------------------+---------------------+---------------------+
    | bi-q8                         | 5 024 174 (50.1%)   | 5 024 174 (50.1%)   | 6 439 173 (63.9%)   |
    +-------------------------------+---------------------+---------------------+---------------------+
    ");
}
