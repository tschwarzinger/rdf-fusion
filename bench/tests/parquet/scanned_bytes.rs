...
async fn test_parquet_scanned_bytes() {
    ...
    +-------------------------------+---------------------+---------------------+
    | explore-q1                    | 1 716 928 (16.9%)   | 1 716 928 (16.9%)   |
    +-------------------------------+---------------------+---------------------+
    | explore-q10                   | 2 959 733 (29.1%)   | 2 959 733 (29.1%)   |
    +-------------------------------+---------------------+---------------------+
    ...
    +-------------------------------+---------------------+---------------------+
    | explore-q3                    | 2 713 475 (26.6%)   | 2 713 475 (26.6%)   |
    +-------------------------------+---------------------+---------------------+
    | explore-q4                    | 4 065 646 (39.9%)   | 4 065 646 (39.9%)   |
    +-------------------------------+---------------------+---------------------+
    | explore-q5                    | 1 420 772 (14.0%)   | 1 420 772 (14.0%)   |
    +-------------------------------+---------------------+---------------------+
    | explore-q7                    | 8 775 337 (86.2%)   | 8 775 337 (86.2%)   |
    +-------------------------------+---------------------+---------------------+
    | explore-q8                    | 12 476 544 (122.5%) | 12 476 544 (122.5%) |
    +-------------------------------+---------------------+---------------------+
