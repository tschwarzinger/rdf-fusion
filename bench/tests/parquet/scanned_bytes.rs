...
async fn test_parquet_scanned_bytes() {
    ...
    +-------------------------------+---------------------+---------------------+-----------------------+
    | Access Pattern                | String(POS)         | String(Sparql(POS)) | PlainTerm(POS)        |
    +-------------------------------+---------------------+---------------------+-----------------------+
    | bound-object                  | 161 637 (1.6%)      | 161 637 (1.6%)      | 9 768 002 (96.9%)     |
    +-------------------------------+---------------------+---------------------+-----------------------+
    | bound-predicate               | 812 875 (8.1%)      | 812 875 (8.1%)      | 9 768 002 (96.9%)     |
    +-------------------------------+---------------------+---------------------+-----------------------+
    | bound-subject                 | 2 120 871 (21.2%)   | 2 120 871 (21.2%)   | 9 768 002 (96.9%)     |
    +-------------------------------+---------------------+---------------------+-----------------------+
    | load-review                   | 5 006 342 (50.0%)   | 5 006 342 (50.0%)   | 19 536 004 (193.7%)   |
    +-------------------------------+---------------------+---------------------+-----------------------+
    | load-review-with-lang-filter  | 5 006 342 (50.0%)   | 5 006 342 (50.0%)   | 19 536 004 (193.7%)   |
    +-------------------------------+---------------------+---------------------+-----------------------+
    | explore-q1                    | 1 421 103 (14.2%)   | 1 421 103 (14.2%)   | 48 840 010 (484.3%)   |
    +-------------------------------+---------------------+---------------------+-----------------------+
    | explore-q10                   | 2 478 451 (24.7%)   | 2 478 451 (24.7%)   | 68 376 014 (678.1%)   |
    +-------------------------------+---------------------+---------------------+-----------------------+
    | explore-q11                   | 1 270 050 (12.7%)   | 1 270 050 (12.7%)   | 19 536 004 (193.7%)   |
    +-------------------------------+---------------------+---------------------+-----------------------+
    | explore-q12                   | 2 204 579 (22.0%)   | 2 204 579 (22.0%)   | 87 912 018 (871.8%)   |
    +-------------------------------+---------------------+---------------------+-----------------------+
    | explore-q2-empty-optional     | 4 139 067 (41.3%)   | 4 139 067 (41.3%)   | 146 520 030 (1453.0%) |
    +-------------------------------+---------------------+---------------------+-----------------------+
    | explore-q2-non-empty-optional | 4 590 217 (45.8%)   | 4 590 217 (45.8%)   | 146 520 030 (1453.0%) |
    +-------------------------------+---------------------+---------------------+-----------------------+
    | explore-q3                    | 1 408 680 (14.1%)   | 1 408 680 (14.1%)   | 58 608 012 (581.2%)   |
    +-------------------------------+---------------------+---------------------+-----------------------+
    | explore-q4                    | 3 473 960 (34.7%)   | 3 473 960 (34.7%)   | 117 216 024 (1162.4%) |
    +-------------------------------+---------------------+---------------------+-----------------------+
    | explore-q5                    | 1 422 641 (14.2%)   | 1 422 641 (14.2%)   | 68 376 014 (678.1%)   |
    +-------------------------------+---------------------+---------------------+-----------------------+
    | explore-q7                    | 6 762 473 (67.5%)   | 6 762 473 (67.5%)   | 117 216 024 (1162.4%) |
    +-------------------------------+---------------------+---------------------+-----------------------+
    | explore-q8                    | 10 794 394 (107.7%) | 10 794 394 (107.7%) | 97 680 020 (968.7%)   |
    +-------------------------------+---------------------+---------------------+-----------------------+
    | explore-q9                    | 1 250 617 (12.5%)   | 1 250 617 (12.5%)   | 19 536 004 (193.7%)   |
    +-------------------------------+---------------------+---------------------+-----------------------+
    | bi-q1                         | 4 075 815 (40.7%)   | 4 075 815 (40.7%)   | 68 376 014 (678.1%)   |
    +-------------------------------+---------------------+---------------------+-----------------------+
    | bi-q2                         | 808 878 (8.1%)      | 808 878 (8.1%)      | 29 304 006 (290.6%)   |
    +-------------------------------+---------------------+---------------------+-----------------------+
    | bi-q3                         | 516 794 (5.2%)      | 516 794 (5.2%)      | 39 072 008 (387.5%)   |
    +-------------------------------+---------------------+---------------------+-----------------------+
    | bi-q4                         | 4 698 443 (46.9%)   | 4 698 443 (46.9%)   | 97 680 020 (968.7%)   |
    +-------------------------------+---------------------+---------------------+-----------------------+
    | bi-q5                         | 4 831 505 (48.2%)   | 4 831 505 (48.2%)   | 107 448 022 (1065.6%) |
    +-------------------------------+---------------------+---------------------+-----------------------+
    | bi-q6                         | 2 906 431 (29.0%)   | 2 906 431 (29.0%)   | 126 984 026 (1259.3%) |
    +-------------------------------+---------------------+---------------------+-----------------------+
    | bi-q7                         | 2 757 060 (27.5%)   | 2 757 060 (27.5%)   | 48 840 010 (484.3%)   |
    +-------------------------------+---------------------+---------------------+-----------------------+
    | bi-q8                         | 5 024 174 (50.1%)   | 5 024 174 (50.1%)   | 107 448 022 (1065.6%) |
    +-------------------------------+---------------------+---------------------+-----------------------+
    ");
}
