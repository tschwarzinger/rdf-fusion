...
async fn test_parquet_file_and_bloom_filter_size() {
    ...
    +-------------------------------------------+-------------------+---------------------+-------------------------+-------------------------+---------------------------+
    | NativeOrder([Subject, Predicate, Object]) | 9 965 980         | 10 266              | 9 686 095               | 174 068                 | 95 539                    |
    +-------------------------------------------+-------------------+---------------------+-------------------------+-------------------------+---------------------------+
    | NativeOrder([Predicate, Object, Subject]) | 10 039 874        | 11 294              | 9 684 650               | 191 017                 | 152 901                   |
    +-------------------------------------------+-------------------+---------------------+-------------------------+-------------------------+---------------------------+
    | NativeOrder([Object, Subject, Predicate]) | 10 248 359        | 10 856              | 9 947 424               | 190 431                 | 99 636                    |
    +-------------------------------------------+-------------------+---------------------+-------------------------+-------------------------+---------------------------+
    ");
}
